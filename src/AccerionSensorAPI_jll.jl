...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import AccerionSensorAPI_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("df519f1b-be81-5d76-8634-ded01372dc30"))
platforms = [Pkg.Artifacts.unpack_platform(e, "AccerionSensorAPI", artifacts_toml) for e in artifacts["AccerionSensorAPI"]]
...
if best_platform === nothing
    @debug("Unable to load AccerionSensorAPI; unsupported platform $(triplet(platform_key_abi()))")
else
...
end  # module AccerionSensorAPI_jll
